...
import com.example.demo.repository.TokenersRepository;
...
public class Tokener {
    ...
    public static TokenersRepository tokenersRepository;
    ...
    public static String validateToken(String token, Long expiredSeconds) {
       Tokeners tokens = new Tokeners();
